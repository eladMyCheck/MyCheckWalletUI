...
open class MCCheckoutViewController: MCAddCreditCardViewController {
    ...
    override open func viewDidLoad() {
        ...
        nc.addObserver(self, selector: #selector(MCCheckoutViewController.receivedLogoutNotification), name: NSNotification.Name(rawValue: Session.Const.loggedOutNotification), object: nil)
    ...
    @objc internal override func setupUI(){
        ...
        pickerDownArrow.kf.setImage(with: LocalData.manager.getCheckoutPageDropdownImageURL(), options:[.scaleFactor(3.0)])
